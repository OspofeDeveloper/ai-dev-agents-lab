...
description: "Patrón UIText en Compose Multiplatform como decisión arquitectónica: qué problema resuelve y cuándo usarlo, separación ViewModel-UI para exponer texto traducible y dinámico desde commonMain."
allowed-tools: [Read]
effort: low
