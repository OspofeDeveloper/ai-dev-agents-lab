...
| wf-spec-features-first | `<prd.md> [--light\|--standard] [--features F-…\|--all-features] [--allow-open-critical-gaps] [--allow-derived-scope-from-analysis] [--skip-conflict] [--skip-readiness]` | orquestador (5 delegaciones por `Agent` síncrono, `run_in_background: false`, [[D-043]]; el delegado ejecuta la sub-skill, no la re-despacha, [[D-044]]); `sdd-features-index.py`; `sdd-analysis-gaps.py --check` (gate de gaps, [[D-042]]) | CU-3.a/b/c/d/l/r · CU-13.b/g · CU-11.f | ✅ | ✅ | ✅ | ✅ | COMPLETADO | — |
