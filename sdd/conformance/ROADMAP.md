...
> 🔒 **`CU-3.d` SELLADO 3/3** (2026-09-24, v0.117.2+b8c645c). Segundo sello de la campaña tras
> `CU-3.a`, y el primero sobre Opus 5.5. Los cuatro puntos en verde tres veces seguidas sobre tres
> anclas que no los tocan. La 3/3 sobrevivió a dos cortes por límite de uso en mitad del fan-out de
> conflictos —ocurridos con los cuatro puntos ya medidos— y la recuperación fue limpia: relanzar
