...
| **Spec** | `wf-spec-analyze`, `wf-spec-features-first`, `wf-spec-fast-track`, `wf-spec-from-code`, `wf-spec-validate`, `wf-spec-conflict`, `wf-spec-readiness`, `wf-spec-delta`, `wf-spec-amend` | `sdd-spec-explorer`, `sdd-spec-writer`, `sdd-spec-auditor` |
