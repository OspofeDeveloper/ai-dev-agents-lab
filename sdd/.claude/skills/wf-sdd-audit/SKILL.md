...
find sdd/.claude/ -name "SKILL.md" 2>/dev/null
find sdd/.claude/ -name "*.md" -path "*/agents/*" 2>/dev/null
find sdd/.claude/CLAUDE.md 2>/dev/null
```
...
- `sdd/.claude/audit_<modo>_<fase>.md`
- Ejemplo: `sdd/.claude/audit_full_global.md`, `sdd/.claude/audit_content_design.md`
...
**Ciclo de vida del reporte:** Una vez que todos los hallazgos del reporte hayan sido corregidos, elimina el archivo `sdd/.claude/audit_<modo>_<fase>.md`. El reporte es un artefacto temporal de trabajo, no documentacion permanente del ecosistema.
