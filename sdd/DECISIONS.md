...
- **Fecha:** 2026-07-09 · **Estado:** Adoptada (piloto en spec + fase PRD; roll-out a design/plan/tasks en curso) · **Relacionada:** [[D-021]] (carril eager), [[D-018]] (dual-audience + herencia en subagentes), [[D-019]] (capa 2 fuera de alcance).
...
**Referencias.** `sdd/pipeline/{spec,prd}/CLAUDE.md` (reglas lazy adelgazadas), `sdd/pipeline/{spec,prd}/routing.md` (carril eager), `sdd/install.sh` (`install_routing_rule`), `sdd/tests/test_install_sh.py`, `sdd/conformance/casos-de-uso/cu-11-enrutado.md` (CU-11.a), `cu-13-enrutado-matriz.md` (validación conductual por fase), `cu-01-inicializar.md` (CU-1.u, instalación on-disk), `sdd/docs/entender/tecnico.md`.
