...
**Referencias.** `sdd/pipeline/{prd,spec,design,plan,tasks}/CLAUDE.md` (reglas lazy adelgazadas, las 5) y `.../routing.md` (carril eager, las 5), `sdd/install.sh` (`install_routing_rule`), `sdd/tests/test_install_sh.py`, `sdd/conformance/casos-de-uso/cu-11-enrutado.md` (CU-11.a), `cu-13-enrutado-matriz.md` (validación conductual por fase), `cu-01-inicializar.md` (CU-1.u, instalación on-disk), `sdd/docs/entender/tecnico.md`.
