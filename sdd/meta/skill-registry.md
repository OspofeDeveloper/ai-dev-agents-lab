...
<!-- Total: 95 skills | 42 wf-* (user-invocable) | 53 kb-* -->
...
|---|---|---|---|
| kb-sdd-audit-content | Criterios normativos para detectar problemas de calidad de contenido: SSoT, SRP, contradicciones, inconsistencias | false | meta/skills/kb-sdd-audit-content/SKILL.md |
| kb-sdd-audit-structural | Criterios normativos para detectar problemas estructurales: referencias rotas, skills huérfanas, rootmap inválido | false | meta/skills/kb-sdd-audit-structural/SKILL.md |
| kb-sdd-creation-guide | Guía operativa para crear y registrar skills, agentes y actualizar el ecosistema SDD | false | meta/skills/kb-sdd-creation-guide/SKILL.md |
| kb-sdd-skill-architecture | Reglas transversales para decidir cuándo crear kb, workflow o agente; SSoT/SRP; tech targets | false | meta/skills/kb-sdd-skill-architecture/SKILL.md |
| kb-sdd-stack-overlay-contract | Contrato normativo de overlays de stack (tech/<stack>): piezas obligatorias/opcionales, override por nombre, init especialista y puntos de integración | false | meta/skills/kb-sdd-stack-overlay-contract/SKILL.md |
| wf-agent-create | Orquestador para crear un nuevo agente; valida KBs, delega a sdd-author | true | meta/skills/wf-agent-create/SKILL.md |
| wf-stack-create | Scaffolding de un nuevo overlay de stack conforme al contrato; delega a sdd-author | true | meta/skills/wf-stack-create/SKILL.md |
| wf-project-init | Onboarding por perfil (dev, product, design, custom): instala siempre el backbone spec/plan/tasks + prd/design segun entrevista, captura el tipo siempre y la entrevista tecnica solo en perfil dev (stack null = pendiente), verifica la instalacion y despacha al init de stack; soporta ampliacion incremental | true | bootstrap/skills/wf-project-init/SKILL.md |
| wf-sdd-audit | Audita el ecosistema detectando referencias rotas, SSoT/SRP violations; modos structural/content/full | true | meta/skills/wf-sdd-audit/SKILL.md |
| wf-sdd-refactor | Refactoriza una skill o agente existente; delega a sdd-author | true | meta/skills/wf-sdd-refactor/SKILL.md |
| wf-sdd-status | Inventario del ecosistema y actualización de skill-registry.md; sin agente | true | meta/skills/wf-sdd-status/SKILL.md |
| wf-skill-create | Orquestador para crear una nueva kb-* o wf-*; valida duplicados, delega a sdd-author | true | meta/skills/wf-skill-create/SKILL.md |
...
| kb-design-expert | Marco de la fase design: principios estructurales, separación producto/feature, orden del pipeline | false | design/skills/kb-design-expert/SKILL.md |
| kb-design-feature-artifacts | Contrato de artefactos por feature: flows, views (SSoT de pantallas), ui_prompt para Stitch | false | design/skills/kb-design-feature-artifacts/SKILL.md |
...
| kb-design-governance | Gobernanza del sistema visual: handoff a plan, política extender vs mutar, versionado semver | false | design/skills/kb-design-governance/SKILL.md |
...
| kb-design-system-contract | Contrato del DESIGN.md: frontmatter YAML, secciones canónicas, visual_personality, color modes, type scale, componentes | false | design/skills/kb-design-system-contract/SKILL.md |
...
| Skill | Descripción | Invocable | Path |
|---|---|---|---|
| kb-kmm-project-state-protocol | Protocolo de precondición de contexto técnico para agentes KMM; SSoT compartida por todos los agentes KMM | false | tech/kmm/skills/kb-kmm-project-state-protocol/SKILL.md |
...
| wf-kmm-init | Inicializa o calibra el estado técnico de un proyecto KMM; genera kmm_project_state.md | true | tech/kmm/skills/wf-kmm-init/SKILL.md |
