...
| kb-tasks-kmm-room | Base de conocimiento para implementar Room en KMP: entidades y DAOs en commonMain, @Database con RoomDatabaseConstructor, builder por plataforma (factory en ca… | false | tech/kmm/skills/tasks/kb-tasks-kmm-room/SKILL.md |
