...
- [ ] `model` seleccionado según tabla de criterios: decisión arquitectónica/codificación agéntica → `claude-opus-5-5`; escritura estructurada/exploración/auditoría/planificación → `claude-sonnet-5`
