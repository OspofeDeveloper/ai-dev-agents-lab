...
> Esta regla es la SSoT que referencia la plantilla de PR (`docs/MEJORAS_FUTURAS.md` O-6): la sección "Impacto conductual" de un PR se rellena aplicando los puntos 1-3 y 8.
