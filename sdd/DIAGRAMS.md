...
- [sdd/pipeline/prd/DIAGRAMS.md](pipeline/prd/DIAGRAMS.md)
- [sdd/pipeline/spec/DIAGRAMS.md](pipeline/spec/DIAGRAMS.md)
- [sdd/pipeline/design/DIAGRAMS.md](pipeline/design/DIAGRAMS.md)
- [sdd/pipeline/plan/DIAGRAMS.md](pipeline/plan/DIAGRAMS.md)
...
2. [sdd/pipeline/prd/DIAGRAMS.md](pipeline/prd/DIAGRAMS.md) para entrada y gobernanza de cambios.
3. [sdd/pipeline/spec/DIAGRAMS.md](pipeline/spec/DIAGRAMS.md) para generación y mantenimiento de specs.
4. [sdd/pipeline/design/DIAGRAMS.md](pipeline/design/DIAGRAMS.md) para Stitch, `DESIGN.md` y prototipado por feature.
5. [sdd/pipeline/plan/DIAGRAMS.md](pipeline/plan/DIAGRAMS.md) para el gate técnico entre Design y Tasks.
