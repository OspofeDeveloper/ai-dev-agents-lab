...
| **Qué no cubre** | Integración Figma (import/export de tokens — evaluación diferida a ROADMAP 7.6); equipos con diseñador que ya produce specs visuales (pueden escribir `DESIGN.md` a mano respetando el contrato y auditarlo con `wf-design-validate`) |
