...
> "Uso: `/spec-validate <archivo_spec.md>`"
> "Ejemplo: `/spec-validate docs/requisitos_spec.md`"
...
> "Este skill espera un spec generado (`_spec.md`). Para analizar un PRD usa `/spec-analyze`."
...
- **Check 2 — Pureza**: consulta `prohibited_items.md` y `error_patterns.md` del skill `spec-expert`; cita cualquier frase que viole la Prueba de Pureza
