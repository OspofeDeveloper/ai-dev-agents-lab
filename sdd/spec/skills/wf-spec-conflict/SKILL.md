...
3. Si no hay specs en el directorio → informa: "No se encontraron specs en `<features-dir>`. Asegúrate de haber ejecutado `/wf-spec-map-generate` o de que la ruta es correcta."
...
- Siguiente paso:
  ...
  - Con conflictos ALTA: "Resuelve los conflictos marcados como ALTA antes de continuar con `/prepare-plan`. Edita los specs afectados y vuelve a ejecutar `/wf-spec-conflict` para verificar."
