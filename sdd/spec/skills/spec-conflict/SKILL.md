...
> "Uso: `/spec-conflict <feature_spec.md> --features-dir <path/features/>`"
> "Ejemplo: `/spec-conflict features/auth/auth_spec.md --features-dir features/`"
...
3. Si no hay specs en el directorio → informa: "No se encontraron specs en `<features-dir>`. Asegúrate de haber ejecutado `/spec-decompose` o de que la ruta es correcta."
...
## Paso 5: Aplicar las 5 reglas de conflict-expert
...
- Siguiente paso:
  ...
  - Con conflictos ALTA: "Resuelve los conflictos marcados como ALTA antes de continuar con `/prepare-plan`. Edita los specs afectados y vuelve a ejecutar `/spec-conflict` para verificar."
