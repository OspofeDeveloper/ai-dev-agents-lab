...
> "Uso: `/spec-finalize <archivo.md>`"
> "Ejemplo: `/spec-finalize docs/requisitos.md`"
...
3. Si tampoco existe ninguno → informa: "No se encontró un archivo de análisis. Primero ejecuta `/spec-analyze <archivo.md>` para generarlo."
...
- Siguiente paso: "Si editas el spec manualmente, puedes re-validarlo con `/spec-validate <path>_spec.md`"
