...
skills: [kb-prd-expert, kb-spec-expert, kb-decompose-expert, kb-conflict-expert, kb-gap-conventions]
memory: project
...
- qué decisiones de negocio necesitan los Specs antes de poder generarse a partir de un PRD ya congelado
- qué elementos del Spec ya vienen en el PRD y cuáles se generarán durante la fase Spec
- si el PRD tiene contaminación técnica que requiera devolverlo a la fase PRD (única condición que justifica modificarlo)
